...
const AboutUsTab: React.FC = () => {
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage your About Us page content dynamically</p>
        </div>
      ...
      {/* Story Section */}
      <div className="p-4 border rounded-lg">
        <h4 className="font-medium mb-3">Our Story Section</h4>
        <div className="space-y-4">
          ...
          <div>
            <Label htmlFor="storyImage">Story Image <span className="text-xs text-gray-500">(Recommended: 1500 x 1024)</span></Label>
            ...
            {data.storyImage && (
              <div className="mt-2">
                <img
                  src={data.storyImage.startsWith('http') ? data.storyImage : `http://localhost:5001${data.storyImage}`}
                  alt="Story"
                  className="w-32 h-32 object-cover rounded border"
                />
              </div>
            )}
            <p className="text-xs text-muted-foreground mt-1">Leave empty to show placeholder</p>
          </div>
      ...
      {/* Mission Section */}
      <div className="p-4 border rounded-lg">
        <h4 className="font-medium mb-3">Mission Section</h4>
        <div className="space-y-4">
          <div>
      ...
      <div className="p-4 border rounded-lg">
        <div className="flex items-center justify-between mb-3">
          <h4 className="font-medium">Values Section</h4>
      ...
      <div className="p-4 border rounded-lg">
        <div className="flex items-center justify-between mb-3">
          <h4 className="font-medium">Stats Section</h4>
      ...
      {/* CTA Section */}
      <div className="p-4 border rounded-lg">
        <h4 className="font-medium mb-3">Call to Action Section</h4>
    ...
    <ImageSelectorModal
      ...
      onSelect={(imagePath) => {
        updateField('storyImage', imagePath);
